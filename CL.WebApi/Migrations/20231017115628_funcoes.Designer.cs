...
namespace CL.WebApi.Migrations
{
    ...
    [Migration("20231017115628_funcoes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CL.Core.Domains.Funcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CL.Core.Domains.Usuario", b =>
                {
            ...
            modelBuilder.Entity("FuncaoUsuario", b =>
                {
                    b.HasOne("CL.Core.Domains.Funcao", null)
                        .WithMany()
                        .HasForeignKey("FuncoesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CL.Core.Domains.Usuario", null)
                        .WithMany()
